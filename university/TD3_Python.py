...
axis.legend()
axis.grid()
axis.set_title("Sinus Function")
plt.show()

axis.hist(Y, bins=10, label="Distribution of Sinus Function", color="green", alpha=0.4)
axis.set_title("Distribution of Sinus Function")
plt.show()
#bin signifie le nombre de barres de l'histogramme
#alpha signifie la transparence de l'histogramme
