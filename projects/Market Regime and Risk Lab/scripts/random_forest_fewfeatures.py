...
predictions = rf.predict(X_valid) # Generate predictions for the selected data.
print(rf.score(X_valid, y_valid)) # Display the result.
...
print("Mean Squared Error (MSE):", mse) # Display the result.
print("Root Mean Squared Error (RMSE):", rmse) # Display the result.
print("Mean Absolute Error (MAE):", mae) # Display the result.
print("R-squared (R2):", r2) # Display the result.
...
lm = RandomForestRegressor() # Create the regression model.
